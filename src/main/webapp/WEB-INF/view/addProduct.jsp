		...
		<form:form action="${pageContext.request.contextPath}/admin/productInventory/addProduct" method="post" modelAttribute="product">
			...
			<div class="form-group">
				<label for="category">Category</label> <label
					class="checkbox-incline"><form:radiobutton
						path="productCategory" id="category" value="instrument" />Instrument</label>
				<label class="checkbox-incline"><form:radiobutton
			...
			<div class="form-group">
				<label for="status">Status</label> <label class="checkbox-incline"><form:radiobutton
